...
It could be argued that the meaning of a hashtag and its correct usage are completely independent from a user's preferences, meaning that user-oriented recommendation systems might not be the best tool for a hashtag recommendation system. Instead, machine-learning algorithms could be used to programmatically deduce the relationships between tweets and hashtags.
