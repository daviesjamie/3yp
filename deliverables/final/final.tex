...
\begin{itemize}
    ...
    \item Flask\footnote{\url{http://flask.pocoo.org}} is a lightweight web application framework made with Python, that makes it simple to create web APIs and WSGI applications. It is used to create and handle the HTTP endpoints for the server.
    \item Tornado\footnote{\url{www.tornadoweb.org}}, a Python web framework and asynchronous networking library, is an excellent library for creating efficient and highly scalable web applications.
