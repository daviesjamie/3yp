...
\todo[inline]{Project Management}

\pagebreak

\chapter{Testing Strategy \& Results}
\label{chap:testing}
...
\todo[inline]{Write some stuff about time management}
\todo[inline]{Add realistic GANTT chart}
...
\chapter{Unit Tests \& Results}
\label{appendix:unittests}
\todo[inline]{Add testing plans and results}

\chapter{System Test Results}
\label{appendix:systemtests}
\todo[inline]{Add big test results}
