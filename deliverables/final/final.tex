...
\afterpage{
    ...
    \begin{landscape}
        ...
        \begin{tabular}{|L{3.5cm}|C{2.1cm}|C{2cm}|L{3.8cm}|L{6.5cm}||C{1.7cm}|}
            ...
            \hline
            \hline
            Unrealistic goals & 0.6 & 4 & Unable to complete work required to fulfil original project goals & Simplify functionality of project to ensure that a core subset of the goals and features could still be achieved, in coordination with the project supervisor & \textbf{2.4} \\
            \hline
