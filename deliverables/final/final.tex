...
One such classification technique is the K-Nearest Neighbour algorithm. It uses the assigned classifications of the $K$ most similar resources to a given query to deduce an appropriate classification for the query. \textcite{Gemmell:2009} do stuff with this.

\subsection{Existing Hashtag Recommendation Systems}
