...
\todo[inline]{Classifier feature extraction/tokenisation}

\subsection{Training}
\todo[inline]{Classifier training}

\subsection{Classifying}
\todo[inline]{Classifier classifying}

\subsection{Optimisation}
\todo[inline]{Classifier Optimisation}

\subsection{Asynchronous Access}
\todo[inline]{Classifier Asynchronous Access}

\subsection{Creating a RESTful API}
\todo[inline]{Classifier RESTful API}

\subsection{Managing State Loading/Saving}
\todo[inline]{Classifier state loading/dumping}
