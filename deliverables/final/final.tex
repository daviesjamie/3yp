...
\begin{itemize}
    \item The system must be capable of training on a sufficiently large dataset of tweets, or potentially even the live Twitter stream.
\end{itemize}
