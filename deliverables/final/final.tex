...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \begin{abstractclass}[text width=4.7cm]{Function}{-3cm, -16cm}
            \operation[0]{+ apply(input : Object)}
        \end{abstractclass}

        \begin{abstractclass}[text width=4.7cm]{Predicate}{3cm, -16cm}
            \operation[0]{+ test(obj : Object)}
        \end{abstractclass}

        \begin{abstractclass}[text width=4.7cm]{Operation}{0cm, -18.5cm}
            \operation[0]{+ perform(obj : Object)}
        \end{abstractclass}
    \end{tikzpicture}
    \caption*{The \textbf{core} classes that make up the Spout library.}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \end{class}
    \end{tikzpicture}
    \caption*{\texttt{Classifier} class, used within the server to provide all recommendations.}
\end{figure}
\pagebreak
