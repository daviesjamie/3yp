...
A critical evaluation was conducted on the system by testing against the formal requirements presented in Chapter~\ref{chap:analysis}, as well as performing some experiments with a large dataset of tweets. Finally, comments are given on the system as a whole and its overall performance.
